...
ALTER TABLE `user` DROP INDEX `ix_user_vk_id`,
...
ALTER TABLE `user_band` MODIFY COLUMN `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `user_band` CHANGE COLUMN `in_master` `is_approved` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0;
