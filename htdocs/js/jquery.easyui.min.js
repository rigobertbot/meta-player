...
$.ajax({type:_d6.method,url:_d6.url,data:_d4,dataType:_d6.dataType,success:function(_da){
...
if (_474.indexOf('.') !== -1) {
    _474 = _474.substr(0, _474.indexOf('.'));
}
...
if (_47e.indexOf('.') !== -1) {
    _47e = _47e.substr(0, _47e.indexOf('.'));
}
var ed=$.data(this,"datagrid.editor");
...
cc.push("\">");
    ...
    // Val Dubrava, 20.03.2012
    var value = _540[_542]
    if (_542.indexOf('.') !== -1) {
        value = _540;
        var parts = _542.split('.');
        for (var index = 0; index < parts.length && value; index ++) {
...
if(col.formatter){
cc.push(col.formatter(value,_540,_53f));
}else{
cc.push(value);
}
}
...
td.hide();
    ...
    var value = rows[_549][_54a]
    if (_54a.indexOf('.') !== -1) {
        value = rows[_549];
        var parts = _54a.split('.');
...
if(col.formatter){
cell.html(col.formatter(value,rows[_549],_549));
}else{
cell.html(value);
}
}
...
$.ajax({type:opts.method,url:opts.url,data:_5dd,dataType:opts.dataType,success:function(data){
