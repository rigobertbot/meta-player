...
function appendScript(src,callBack){
    ...
    element.onload=element.onreadystatechange=function(){
        if(!_7&&(!element.readyState||element.readyState=="loaded"||element.readyState=="complete")){
            _7=true;
...
function _10(_11,_12){
    ...
    if(easyloader.css&&_13["css"]){
        if(/^http/i.test(_13["css"])){
            ...
            var url=easyloader.base+"../css/themes/"+easyloader.theme+"/"+_13["css"];
        }
        _c(url,function(){
            _15="loaded";
...
function _17(_18,_19){
    ...
    function add(_1b){
        ...
        var d=plugins[_1b]["dependencies"];
        if(d){
...
easyloader={
    ...
    load:function(_1f,_20){
        if(/\.css$/i.test(_1f)){
            ...
            if(/\.js$/i.test(_1f)){
                if(/^http/i.test(_1f)){
                    appendScript(_1f,_20);
                }else{
                    appendScript(easyloader.base+_1f,_20);
                }
            }else{
                _17(_1f,_20);
            }
